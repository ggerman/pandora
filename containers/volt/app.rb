...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'rubylit.com'
  config.app_name = 'RubyLitoral'
  config.mailer.from = 'Rubylit <no-reply@rubylit.com>'
  ...
  #
  config.app_secret = 'Vgs-S2pkvAIdi-rZS3igjPT4YQhWzPxACdGv2hqTT29sSzaryS0YZlAslyHPHyLfAgk'
